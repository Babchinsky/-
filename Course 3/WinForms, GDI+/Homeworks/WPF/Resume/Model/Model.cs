   ...
   public class M_Resume:DependencyObject
    {
        ...
        public M_Resume(string FIO, int Age, string Family, string Address, string Email,bool tech,bool lang)
        {
            this.FIO = FIO;
            this.Age = Age;
            this.Family = Family;
        ...
        static M_Resume()
        {
            ...
            AddressProperty = DependencyProperty.Register("Address", typeof(string), typeof(M_Resume));
